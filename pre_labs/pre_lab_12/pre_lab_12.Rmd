...
```{r}
mde_url <- "https://news.maryland.gov/msde/category/newsreleases/"
```
...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** Shows theo one news release from the date
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer**
...
**Task** Right-click on the first release date and choose "Inspect". You should see multiple
...
**Task** Run the following code in the gray-colored codeblock below to find the
...
tags there are in the HTML source? **Answer** There is 20 <ul> tags 
...
tags. Describe the output: **Answer** I get words inside the list 
...
tags into a dataframe

**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** It is now a tibble  
