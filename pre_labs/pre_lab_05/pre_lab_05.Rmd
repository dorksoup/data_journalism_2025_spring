...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer** The headers are not right, its supposed to be data row.
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer** There isnt actual headers anymore. the columns are not named. 
...
**Task** Run the codeblock below. What else do we need to do? **Answer** the jurisdiction column needs to be cleaned up from all the dots
