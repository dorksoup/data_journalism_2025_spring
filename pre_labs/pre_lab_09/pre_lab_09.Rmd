...
**Answer** Copy the url of the graphic you published here. It will begin with <https://datawrapper.dwcdn.net/>. Don't copy the browser's current url. https://datawrapper.dwcdn.net/RfyCQ/1/  
...
md_gov_county <- md_gov_county |>
  mutate(total = Cox +  Moore + Lashar + Wallace + Harding) |>
...
Now the data map only shows Maryland with the counties colored in.
...
Before when hovering over each county, the tooltips showed the exact percentage of moore voters. Now the tooltips shows the county name and the pct_moore with a percentage. Easier to read 
...
**Task** Click the "Proceed" button until you get to the "Publish & Embed" tab, then click "Publish Now". Copy the published URL (like you did for the chart above) and paste it below. **Answer** https://datawrapper.dwcdn.net/89ug9/1/
