...
```{r echo=FALSE}
census_api_key("c835b290fcfd849bd146850c22c7b7ddda145ae2", install=TRUE)
```
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** Howard County Residents have higher income than other Maryland county residents.
...
Is the difference between Calvert and Montgomery significant? **Answer** Not really
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** The average income for 60 or more percent graduates enrolling in college is higher than the 40 percent  
...
**Task** What is another question you could ask of this data? **Answer** Is there zipcode group that has a low number of highschool graduates with a lower average household income. Can we find the relationship  
